...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/linkmanAction_add.action" method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select list="#customerList" name="customer.custId" listKey="custId" listValue="custName"/>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
