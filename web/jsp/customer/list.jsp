                            ...
                            <TABLE id=grid
                                ...
                                <c:forEach items="${list}" var="customer">
                                    <TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                                        ...
                                        <TD>${customer.source.dictItemName}</TD>
                                        <TD>${customer.industry.dictItemName}</TD>
                                        <TD>${customer.custAddress }</TD>
                                        <TD>${customer.custPhone }</TD>
                                        <TD>
                                            <a href="${pageContext.request.contextPath }/customerAction_initUpdate?custId=${customer.custId}">修改</a>
                                            &nbsp;&nbsp;
                                            <a href="${pageContext.request.contextPath }/customerAction_delete?custId=${customer.custId}"
